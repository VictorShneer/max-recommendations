...
class AnalyticsBar(FlaskForm):
    ...
    clause_visits = SelectField('От/До/Дата', choices=[(0,'От'), (1,'До'), (2,'Дата'), (3,'Не выбрано')], coerce=int, default =3)
    last_visit_date = DateField('Дата последнего визита', format='%d/%m/%Y')
    clause_visits_from_to = SelectField('От/До/Количество', choices=[(0,'От'), (1,'До'), (2,'Количество'), (3,'Не выбрано')], coerce=int, default=3)
    ...
    clause_goals = SelectField('От/До/Количество', choices=[(0,'От'), (1,'До'), (2,'Количество'), (3,'Не выбрано')],coerce=int, default=3)
