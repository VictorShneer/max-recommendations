...
class AnalyticsBar(FlaskForm):
    ...
    clause_visits = SelectField('От/До/Дата', choices=[(0,'Не выбрано'), (1,'От'), (2,'До'), (3,'Дата')], coerce=int, default =3)
    last_visit_date = DateField('Дата последнего визита', format='%d/%m/%Y')
    clause_visits_from_to = SelectField('От/До/Количество', choices=[(0,'Не выбрано'), (1,'От'), (2,'До'), (3,'Количество')], coerce=int, default=0)
    ...
    clause_goals = SelectField('От/До/Количество', choices=[(0,'Не выбрано'), (1,'От'), (2,'До'), (3,'Количество')],coerce=int, default=0)
